...
class LocomotivaDiscosScraper:
    ...
    def executar(self) -> None:
        ...
        logger.info(f"Iniciando extração de produtos com 'CD' do site Locomotiva Discos no modo '{self.modo}'...")
...
def main():
    ...
    try:
        ...
        parser = argparse.ArgumentParser(description='Scraper de CDs usados do site Locomotiva Discos')
