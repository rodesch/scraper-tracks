...
LOG_FILENAME = f"logs/scraper_locomotiva_{data_hora}.log"
...
class LocomotivaDiscosScraper:
    """Classe para extrair informações de CDs usados do site Locomotiva Discos"""
    
    BASE_URL = "https://www.locomotivadiscos.com.br"
    DEFAULT_OUTPUT = "produtos_cd_locomotiva.csv"
    ...
    def __init__(self, url_inicial: str = None, 
        ...
        """
        self.url_inicial = url_inicial or "https://www.locomotivadiscos.com.br/cds-usados-ct-434a0"
    ...
    def extrair_categoria(titulo: str) -> str:
        ...
        # Categorias do site da Locomotiva Discos
        categorias = [
            (["rock", "pop", "guitar"], "Rock / Pop"),
            (["brasil", "mpb", "samba", "bossa", "choro", "nacional"], "Música do Brasil"),
            (["jazz"], "Jazz"),
            (["blues"], "Blues"),
            (["soul", "funk", "r&b", "hip hop", "rap"], "Soul / Funk / Hip Hop"),
            (["punk", "hardcore"], "Punk / Hardcore"),
            (["metal", "heavy", "thrash", "death"], "Metal"),
            (["world", "música do mundo", "latin"], "World Music"),
            (["reggae", "ska", "dub"], "Reggae / Ska / Dub"),
            (["eletrônic", "techno", "house", "trance", "dance"], "Eletrônico / Experimental"),
            (["trilha", "soundtrack", "ost"], "Trilha Sonora"),
            (["clássic", "erudito", "orquestra", "symphony"], "Música Clássica"),
            (["folk", "country"], "Folk")
        ]
    ...
    def encontrar_proxima_pagina(self, soup: BeautifulSoup, pagina_atual: int) -> Optional[str]:
        ...
        try:
            ...
            # cds-usados-ct-434a0?pageNum=X&sortBy=Y
            return f"cds-usados-ct-434a0?pageNum={pagina_atual + 1}&sortBy=1"
    ...
    def executar(self) -> None:
        ...
        logger.info(f"Iniciando extração de produtos com 'CD' do site Locomotiva Discos...")
...
def main():
    ...
    try:
        ...
        scraper = LocomotivaDiscosScraper(
            max_paginas=340,  # O site indica ter 340 páginas
